...
Financial reporting and data processing application built with ASP.NET Core MVC, SQL Server, Entity Framework Core, Hangfire, Excel import, and external exchange-rate API integration.
...
Logistics-focused CMS and admin panel built with ASP.NET Core MVC and MongoDB. Includes cookie authentication, reusable MongoDB CRUD services, content management modules, shipment management, and shipment tracking history.

**Tech:** ASP.NET Core MVC, C#, MongoDB, Cookie Authentication, AutoMapper, Service Layer
